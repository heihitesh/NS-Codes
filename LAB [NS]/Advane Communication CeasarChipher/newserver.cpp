...
int main(int argc, char *argv[])
{
    ...
    int bindStatus = bind(serverSd, (struct sockaddr*) &servAddr,
        sizeof(servAddr));
    //function bind will associate the socket created to a particular network address (IP Address and host).
    if(bindStatus < 0)
    {
    ...
    listen(serverSd, 5);
    //receive a request from client using accept. It resctricts the number of clients acceptable.
